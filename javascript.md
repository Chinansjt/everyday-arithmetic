...
## 自我介绍
面试官您好，我叫宁柏森，目前拥有4年多的前端开发工作经验，在电商、外卖和直播行业有一定的涉猎。我的核心技术栈为Vue，具备从0到1使用uni-app和taro进行跨平台应用开发的实战经验。我对前端工程化和性能优化有深入的理解和实践，比如之前在一个大型外卖平台项目中，我通过切片和懒加载策略，显著提升了外卖点餐页面的响应速度和整体性能，提高了用户体验。

在过去几年，我负责并参与了多个重要项目，其中包括澳门几个市场领先的外卖和直播平台。这些项目不仅锻炼了我的技术能力，也增强了我在跨部门团队中的沟通、协调和项目管理能力。我热衷于和同事一起分享技术心得，积极推动内部知识共享，助力团队成长。

我对前端技术充满热情，始终保持对新技术的好奇心和学习欲望。我期待有机会在贵公司进一步挑战自我，与团队一起创造更大的价值，共同实现更高的目标。