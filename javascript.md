...
## 自我介绍
面试官您好，我叫宁柏森，目前拥有4年多的前端开发工作经验，在电商、外卖和直播行业有一定的涉猎。我的核心技术栈为Vue，具备从0到1使用uni-app和taro进行跨平台应用开发的实战经验。我对前端工程化和性能优化有一定的理解和实践，比如之前在一个大型外卖平台项目中，我通过切片和懒加载策略，显著提升了外卖点餐页面的响应速度和整体性能，提高了用户体验。
